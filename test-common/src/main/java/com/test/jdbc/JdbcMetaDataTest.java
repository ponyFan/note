...
public class JdbcMetaDataTest {
    ...
    //获得url
    private static String URL = "jdbc:mysql://172.22.6.3:3306/testDB";
    //获得连接数据库的用户名
    private static String USER = "root";
    //获得连接数据库的密码
    private static String PASS = "Tw#123456";
    ...
    public static void getDataBaseInfo() {
        ...
        try{
            ...
            JdbcMetaDataTest.close(rs,conn);
        }
    }
    ...
    public static void getTablesInfo(){
        ...
        try {
             ...
             */
            rs = dbmd.getTables(null, null, "connection", new String[]{"TABLE","VIEW"});
     ...
     * @throws
     */
    public static void getColumnsInfo(String db, String table){
        Connection conn =  getConnection();
        ResultSet rs = null;
        ...
        try{
             ...
             */
            rs =dbmd.getColumns(db, null, table, null);
    ...
    public static void main(String[] args) {
       ...
       /* getIndexInfo();  //获取表索引信息*/
        getColumnsInfo("testDB", "tables"); //获取表中列值信息
    }
}
